define(function(require, exports, module) {
    ...
    var AutoComplete = Overlay.extend({
        ...
        _initInput: function() {
            // 构造选择器
            var inputEle = $(this.get('trigger')),
                cont = $('<div class="ali-autocomplete-cont" data-auto-id="' + this.get('trigger') + '"><ul class="ali-autocomplete-choises"><li class="ali-autocomplete-field"><input type="text" autocomplete="off" autocapitalize="off" spellcheck="false" tabindex="0" /></li></ul></div>');
        ...
        _bindHandle: function() {
            ...
            this.input
                ...
                .on('remove', this._setInputVlaue, this)
                .on('keyBack', this._removeOne, this)
                //.on('selectmax', this._selectMax, this) // 选择最多限制
        ...
        _handleSelection: function(e) {
            ...
            if (index >= 0 && item) {
                ...
                this.input.setValue(itemData);/////////////////////////////////叠加
                this.input.emptyInput();
